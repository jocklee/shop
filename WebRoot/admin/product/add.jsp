		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct_save.action" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td width="18%" align="" bgColor="#f5fafe" class="ta_01" >
						<select name="is_hot">
					...
					<td class="ta_01" bgColor="#ffffff"  >
						<input type="text" name=inventory value=""  class="bg"/>
					</td>
				...
				<tr>
					...
					<td width="18%" align="" bgColor="#f5fafe" class="ta_01" colspan="3">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3" >
						<textarea name="pdesc" rows="5" cols="25"></textarea>
					</td>
				</tr>
